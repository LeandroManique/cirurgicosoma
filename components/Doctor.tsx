      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid grid-cols-1 lg:grid-cols-[1.1fr_0.9fr] gap-12 lg:gap-16 items-start">
          ...
          <aside className="w-full">
            <div className="relative h-[420px] sm:h-[520px] lg:h-[720px] overflow-hidden rounded-sm shadow-lg border border-warmDark bg-white">
              <img
                src="/dr_fabio.jpeg"
                alt="Retrato do Dr. Fábio Guarnieri"
                className="w-full h-full object-cover object-center"
              />
              <div className="absolute inset-0 bg-gradient-to-t from-primary/15 via-transparent to-transparent pointer-events-none"></div>
            </div>
          </aside>
        </div>
      </div>
